...
def main():
    try:
        ...
        if not mf.check_table_existence(table_name, db_file_path):    
            i.Import_SqlServer_Data_To_SqLite(server_name,database_name,table_name,n,db_file_path,project_name,sql_server_username,sql_server_password,schema_name)
