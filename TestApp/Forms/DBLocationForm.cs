...
//        // Declare the PictureBox for the eye icon
...
//                // Check if password field has text and toggle eye icon visibility
...
//            // Toggle eye icon visibility based on whether password is entered
//            picEye.Visible = isPasswordNotEmpty;

//            // Debugging: Output the current state to verify
...
//        {
//            // Toggle the password visibility on eye icon click
//            txtForPassword.UseSystemPasswordChar = !txtForPassword.UseSystemPasswordChar;
//        }
//    }
//}
