        ...
        private void DeleteSelectedNode()
        {
            ...
            if (selectedNode.Parent != null && selectedNode.Parent.Text == "Projects")
            {
                ...
                if (project != null)
                {
                    ...
                    string pythonfile = @"C:\Users\Dinesh Puvvala\source\repos\DE-IDENTIFICATION_TOOL_new\TestApp\PythonScripts\DeleteProjectConnection.py";
            ...
            else if (selectedNode.Parent != null && selectedNode.Parent.Parent != null && selectedNode.Parent.Parent.Text == "Projects")
            {
                ...
                if (project != null)
                {
                    ...
                    string pythonfile = @"C:\Users\Dinesh Puvvala\source\repos\DE-IDENTIFICATION_TOOL_new\TestApp\PythonScripts\DeleteTableConnection.py";
